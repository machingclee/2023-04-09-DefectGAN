...
class ModelAndTrainingConfig:
    ...
    disc_model_path = "checkpoints\\disc_epoch_2_batch_500.pt"
    gen_model_path = "checkpoints\\gen_epoch_2_batch_500.pt"
    start_epoch = 3
...
class GenLambdas:
    g_spatial_cat_similarity_loss = 0

    g_cycle_loss = 10
    g_mask_cycle_loss = 10

    g_mask_vanishing_loss = 0
